...
void main() {
  test('诊断 payload 包含异常上下文并截断敏感/超长字段', () {
    final event = DiagnosticLogService.buildEvent(
      error: Exception(
        'request failed api_token=secret-value Authorization: Bearer bearer-secret',
      ),
    ...
    expect(data['error'], isNot(contains('bearer-secret')));
    expect(data['msg'], isNot(contains('bearer-secret')));
