...
class AppColors {
  ...
  static const offline = Color(0xFF6B7280); // color.connection.offline
}
  ...
  Widget build(BuildContext context) {
    final card = Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.fromBorderSide(side ?? const BorderSide(color: AppColors.border, width: 1)),
...
class ConnectionStatus extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (syncing) {
      inner = const Row(
        ...
        children: [
          ...
          SizedBox(width: 6),
          Text('同步中', style: AppTextStyles.caption),
        ],
      );
    } else if (offline) {
      inner = const Row(
    ...
    return GestureDetector(
      onTap: offline && onRetry != null ? onRetry : null,
      child: Container(
