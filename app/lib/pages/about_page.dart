        ...
        children: const [
          ...
          _SectionCard(
            body:
                ...
                '中间那个橙色的麦克风就是最快的那只手——按住说话，松手完事。单次录音最长 60 秒，最后 10 秒会提示，时间到自动结束并继续处理已录内容。\n\n'
...
class _FeaturesCard extends StatelessWidget {
  ...
  static const _items = [
    (Icons.mic_rounded, '语音录入', '进场、退场、压力值，一句话搞定；多人一次报完一次确认，单人气瓶容量可单独改；单次最长 60 秒，最后 10 秒提示并自动处理'),
    (
    ...
    (
      ...
      '断网可用',
      '语音识别与语义解析支持本机运行；本地 ASR 主模型约 75MB，另有可选的 9.8MB 降噪模型；模型下载和缓存启用前会校验完整性；低存储时不会自动删除当前模型或现场数据，可清理空间后重试或继续联网识别',
    ),
    (
